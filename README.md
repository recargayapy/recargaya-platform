...
| `npm run runtime` | que la fecha de compatibilidad esté escrita, y 35 pruebas sobre workerd |
| `npm run mutar` | rompe 84 invariantes a propósito y exige que todos mueran |
